...
@SET "ENCODING=65001"
@SET "CURRENT_DIR=%~dp0"
@SET "SCRIPT_NAME=Create Windows exporter service"
...
@SET "SERVICE_DISPLAY_NAME=Сбор метрик Windows"
@SET "BIN_PATH=%CURRENT_DIR%windows-exporter\windows_exporter-0.26.2-amd64.exe"

CALL :print %NF_CAYN% "Создание службы сбора метрик Windows" Print_border
CALL :run_command sc create "%SERVICE_NAME%" binPath= "%BIN_PATH%" DisplayName= "%SERVICE_DISPLAY_NAME%" type= own start= auto
CALL :run_command_with_line sc start "%SERVICE_NAME%"
